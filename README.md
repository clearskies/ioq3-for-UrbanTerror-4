...
### Cvars ###
   ...
   + `con_nochat <0|1>` - Disables console chat output <del>(when disabled, it will output a newline in the place of a chat message - I don't know why)</del>. Default is `0`
